    ...
    <div className='footer'>
      <div className='footer__section footer__section--disclaimer'>
        ...
        <p>
          ...
          only. By no means is any information presented herein intended to
          substitute for the advice provided to you by your own physician or
          health care provider. You should not use any information contained in
          this site to self-diagnose or personally treat any medical condition
          or disease or prescribe any medication. If you have or suspect you
          have a medical condition you are urged to contact your personal health
          care provider.
        </p>
      </div>

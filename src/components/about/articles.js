...
const articles = [
    {
        ...
        text: [
            <div key={uuid()}>
                ...
                <p>
                    She studied Unified Therapy™ under Dr Paul Canali, the founder of Unified Therapy™ and worked as a Therapist at the Evolutionary Healing Institute since 2011. Barbara became a Unified Therapy™ Healing Instructor in 2017.
                </p>
                <p>
    ...
    },
    {
        ...
        text: [
            <div key={uuid()}>
                ...
                <p>
                    Everything we need is already there because it’s an internal “there”, not a material "out there". When we chase outside of ourself, we lose ourself.  When we turn inward, we awaken.
                </p>
                <p><em>

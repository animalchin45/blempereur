...
const Header = () => {
    ...
    return (
        <div className="header" style={headerBackgroundColor ? colorOn : colorOff}>
            <div className="header__logo" style={headerLogo ? {opacity: 1} : {opacity: 0}}>
                <Link to="/">
            ...
            <nav className="header__nav">
                <NavLink activeClassName="btn__nav--active" className="btn__nav" to="/unified-therapy">Unified Therapy Process</NavLink>
                <NavLink activeClassName="btn__nav--active" className="btn__nav" to="/newclients">New Clients</NavLink>
                <NavLink activeClassName="btn__nav--active" className="btn__nav" to="/aboutme">About Me</NavLink>
            </nav>
        </div>
    )
}
